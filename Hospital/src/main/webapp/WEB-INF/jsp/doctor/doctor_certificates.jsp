...
<div id="recordModal">
	...
	<button onclick="document.getElementById('recordModal').style.display='none'">닫기</button>
</div>

<!-- 작성 완료 모달 -->
<div id="savedModal">
	<p style="text-align: center;">기록지가 성공적으로 작성되었습니다.</p>
	<button onclick="document.getElementById('savedModal').style.display='none'">확인</button>
</div>
	...
	for (var i = 0; i < buttons.length; i++) {
		buttons[i].addEventListener("click", function () {
			...
			fetch(url)
				...
				.then(function (data) {
					var html = ""
						+ "<p><strong>작성자:</strong> " + data.doctorId + "</p>"
						+ "<p><strong>환자이름:</strong> " + data.patientName + "</p>"
