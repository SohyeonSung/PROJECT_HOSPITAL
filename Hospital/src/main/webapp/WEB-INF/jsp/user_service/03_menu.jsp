...
<div class="bg-white rounded-lg shadow border border-gray-200 w-full h-full min-h-[500px] flex flex-col justify-between">
  ...
  <nav class="p-4">
    <ul class="divide-y divide-gray-200 text-gray-900 font-bold text-[15px] tracking-tight">
      <li>
        <a href="${pageContext.request.contextPath}/03_faq/list.do" class="block py-2 hover:text-blue-600 transition-colors duration-150">자주 묻는 질문 (FAQ)</a>
      </li>
      <li>
        <a href="${pageContext.request.contextPath}/03_feedback/list.do" class="block py-2 hover:text-blue-600 transition-colors duration-150">고객의 소리</a>
      </li>
      <li>
        <a href="${pageContext.request.contextPath}/03_praise/list.do" class="block py-2 hover:text-blue-600 transition-colors duration-150">칭찬 릴레이</a>
      </li>
    </ul>
  </nav>
