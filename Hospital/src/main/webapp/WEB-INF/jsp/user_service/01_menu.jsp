    ...
    <ul class="divide-y divide-gray-200 text-gray-900 font-bold text-[15px] tracking-tight">
      <li>
        <a href="${pageContext.request.contextPath}/01_notice/list.do"
           class="block py-2 hover:text-blue-600 transition-colors duration-150">공지사항</a>
      </li>
      <li>
        <a href="${pageContext.request.contextPath}/01_lecture/list.do"
           class="block py-2 hover:text-blue-600 transition-colors duration-150">강좌 및 행사 안내</a>
      </li>
    </ul>
  </nav>
