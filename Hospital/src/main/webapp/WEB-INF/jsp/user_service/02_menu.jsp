...
<div class="bg-white rounded-lg shadow border border-gray-200 w-full h-full min-h-[500px] flex flex-col justify-between">
  ...
  <nav class="p-4">
    <ul class="divide-y divide-gray-200 text-gray-900 font-bold text-[15px] tracking-tight">
      <li>
        <a href="#" class="block py-2 hover:text-blue-600 transition-colors duration-150">재증명 발급</a>
      </li>
      <li>
        <a href="#" class="block py-2 hover:text-blue-600 transition-colors duration-150">의무 기록 사본 신청</a>
      </li>
      <li>
        <a href="#" class="block py-2 hover:text-blue-600 transition-colors duration-150">서류 발급 이력 조회</a>
      </li>
    </ul>
  </nav>
