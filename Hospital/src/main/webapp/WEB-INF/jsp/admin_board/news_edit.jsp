...
<div class="con_wrap bg_13 form-wide">
	...
	<form
		action="${pageContext.request.contextPath}/admin_board/news_update.do"
		method="post">
		<input type="hidden" name="eventId" value="${event.eventId}" /> <input
			type="hidden" name="category" value="소식" />
			...
			<tbody>
				<tr>
					...
					<td><input type="text" id="title" name="title"
						value="${event.title}" required placeholder="제목을 입력하세요"
						style="width: 100%;"></td>
				</tr>
				...
				<tr>
					...
					<td><textarea id="description" name="description"
							...
							placeholder="내용을 입력하세요" required>${event.description}</textarea>
					</td>
				</tr>
			</tbody>
		</table>
